...
var sidebar = require("sdk/ui/sidebar").Sidebar({
  ...
  onAttach: function (sbWorker) {
	...
	sbWorker.port.on("changeOvermatchThreshold", function(msg){
		try {CSworker.port.emit("changeOvermatchThreshold",msg);} catch (ex){ console.log("navigate to a site first!") };
	});
	sbWorker.port.on("changeTagThreshold", function(msg){
		try {CSworker.port.emit("changeTagThreshold",msg);} catch (ex){ console.log("navigate to a site first!") };
	});
	...
	sbWorker.port.on("checkViolations", function(msg){
		try {CSworker.port.emit("checkViolations",msg);} catch (ex){ console.log("navigate to a site first!") };
	});
