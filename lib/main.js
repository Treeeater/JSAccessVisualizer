...
console.log(system.staticArgs);			//json as argument in --static-args="{a:b}"
...
var sidebar = require("sdk/ui/sidebar").Sidebar({
  ...
  onAttach: function (sbWorker) {
	...
	sbWorker.port.on("changeThreshold", function(msg){
		CSworker.port.emit("changeThreshold", msg);
	});
...
tabs.on("ready", function(tab) {
  ...
  CSworker.port.on("openInteractive",function(msg){
	v.openInteractive(msg);
  });
  ...
  CSworker.port.on("changedThreshold",function(msg){
	v.changedThreshold(msg);
  });
