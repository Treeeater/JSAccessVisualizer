...
exports.loadExistingPolicies = function(msg){
	var tpd = msg.tpd;
	var hd = msg.hd;
	var filePath = require("sdk/system").pathFor("ProfD") + "\\..\\..\\policies\\extra\\" + hd + "\\" + tpd + ".txt";
	var genericPath = require("sdk/system").pathFor("ProfD") + "\\..\\..\\policies\\extra\\" + hd + "\\generic.txt";
	var basePath = require("sdk/system").pathFor("ProfD") + "\\..\\..\\policies\\" + tpd + ".txt";
